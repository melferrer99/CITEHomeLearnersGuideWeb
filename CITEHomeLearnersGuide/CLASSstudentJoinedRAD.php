...
<body>
    ...
    <div class="col-12 padding">
        <div class="col-2" style="margin: auto;"><h2>CLASSROOM RAD</h2></div>
    </div>

<!--------------------------LEFT TABLE----------------------->

    <div class="col-12 padding">
        <input type="hidden" id="SORTlearningSystem" value="RAD" class="form-control">
...
<!--------------------------RIGHT TABLE----------------------->
    ...
    <script type="text/javascript" src="js/StudentJoinedFunction.js"></script>
