...
<body>
        ...
        <div class="col-8" style="margin: auto;">
            ...
            <div class="col-12 padding">
                <div class="row col-6 text-center jumbotron padding" style="margin: auto;">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 ">
                            <div class="col-12">
                                <button id="getData" type="button" class="btn btn-primary form-control">Load</button>
                            </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="js/ClassroomFunction.js"></script>
