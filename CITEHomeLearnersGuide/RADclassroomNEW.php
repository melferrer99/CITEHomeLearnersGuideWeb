...
<body>
    ...
    <div class="container-fluid" style="margin-top: 10px;">
        ...
        <div class="row rightside-input text-center jumbotron padding col-8" style="margin: auto;">
            ...
            <div class="col-12">
                ...
                <form id="addUser" class="form-inline" method="POST" action="">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2 subcode padding">
                        <label for="gclasstLink" class="sr-only">GOOGLE CLASSROOM LINK</label>
                        <label>GOOGLE CLASSROOM LINK</label>
                        <input id="gclasstLink" type="text" class="form-control" name="gclasstLink" placeholder="Classroom Link"
                               required autofocus >
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2 subcode padding">
                        <label for="moduleslink" class="sr-only">MODULES LINK</label>
                        <label>MODULES LINK</label>
                        <input id="moduleslink" type="text" class="form-control" name="moduleslink" placeholder="Modules Link"
                               required autofocus >
                    </div>

                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2 subcode padding">
                        <label for="facebooklink" class="sr-only">FACEBOOK LINK</label>
                        <label>FACEBOOK LINK</label>
                        <input id="facebooklink" type="text" class="form-control" name="facebooklink" placeholder="FB Group Link"
                               required autofocus onkeyup="btnActivation()">
                    </div>

                    <input id="username" type="hidden" name="username" value="<?php echo $_SESSION['userName'];?>">
                    
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-1 subcode ">
                        <div class="col-12">
        ...
        <div class="col-10" style="margin: auto;">
            ...
            <div class="col-12 padding">
                <div class="row col-4 text-center jumbotron padding" style="margin: auto;">
...
<!--                     <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4  ">
                         <select id="SORTtitle" type="text" class="form-control" name="SORTtitle" required="" autofocus="">
                                <option disabled="true" selected="">Title</option>
                        </select>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 ">
                            <div class="col-12">
                                <a href="RADclassroomNEW.php"><button type="button" class="btn btn-primary form-control">View all</button></a>
                            </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered" style="width:55%;">
                <div class="modal-content" style="overflow: hidden;">
                    <div class="modal-header">
                        <h4 class="modal-title" id="custom-width-modalLabel">IREGULAR STUDENTS</h4>
                        <a href="RADclassroomNEW.php"><button type="button" class="close"
                                aria-hidden="true">×
                        </button></a>
                    </div>
                    <div class="modal-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="tbodySTUDENTSjoined"></tbody>

                        </table> 

                    </div>
                    <div class="modal-footer">
                        <a href="RADclassroomNEW.php"><button type="button" class="btn btn-light">Close
                        </button></a>
        ...
        <div id="update-modal" data-backdrop="static" data-keyboard="false" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" style="width:55%;">
                <div class="modal-content" style="overflow: hidden;">
                    ...
                    <div class="modal-footer">
                        <a href="RADclassroomNEW.php"><button type="button" class="btn btn-light"
                                >Close
                        </button></a>
    ...
    <script type="text/javascript" src="js/ClassroomFunctionNEW.js"></script>
