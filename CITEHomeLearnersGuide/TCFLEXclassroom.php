        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="TCuserStudent.php">USER</a>
                    </li>
                    <li class="nav-item">
...
<!--                     <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3  ">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 ">
                            <div class="col-12">
                                <a href="TCFLEXclassroom.php"><button type="button" class="btn btn-primary form-control">View all</button></a>
                            </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered" style="width:55%;">
                <div class="modal-content" style="overflow: hidden;">
                    <div class="modal-header">
                        ...
                        <a href="TCFLEXclassroom.php"><button type="button" class="close"
                                aria-hidden="true">×
                        </button></a>
                    </div>
                    ...
                    <div class="modal-footer">
                        <a href="TCFLEXclassroom.php"><button type="button" class="btn btn-light"
                                >Close
                        </button></a>
    ...
    <script type="text/javascript" src="js/TCClassroomFunction.js"></script>
