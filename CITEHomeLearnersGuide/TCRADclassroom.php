...
<!--                     <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3  ">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 ">
                            <div class="col-12">
                                <a href="TCRADclassroom.php"><button type="button" class="btn btn-primary form-control">View all</button></a>
                            </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered" style="width:55%;">
                <div class="modal-content" style="overflow: hidden;">
                    <div class="modal-header">
                        ...
                        <a href="TCRADclassroom.php"><button type="button" class="close"
                                aria-hidden="true">×
                        </button></a>
                    </div>
                    ...
                    <div class="modal-footer">
                        <a href="TCRADclassroom.php"><button type="button" class="btn btn-light"
                                >Close
                        </button></a>
