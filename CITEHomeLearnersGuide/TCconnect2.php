	...
	<div class="row">
		...
		<div class="container col-4">	
			...
			<div class="body-content col-12 text-center">
				<div class="col-12">
					<a href="TCFLEXclassroom.php"> <button type="button" class="btn btn-lg" style="background: lightgreen; color: #fff;">CLASSROOM</button> </a>
					<a href="TCFLEXfacebook.php"><button type="button" class="btn btn-primary btn-lg">FACEBOOK</button></a>
				</div>
			</div>
		</div>
