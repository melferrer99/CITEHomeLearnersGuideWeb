...
echo "<script LANGUAGE='JavaScript'>
    ...
    window.location.href='TCconnect_1st_01_class.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_1st_01_class.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_1st_02_class.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub2'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_1st_02_class.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_1st_03_class.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub3'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_1st_03_class.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_1st_04_class.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub4'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_1st_04_class.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_1st_05_class.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub5'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_1st_05_class.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_1st_06_class.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub6'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_1st_06_class.php');
