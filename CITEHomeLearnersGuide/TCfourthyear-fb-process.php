...
echo "<script LANGUAGE='JavaScript'>
    ...
    window.location.href='TCconnect_4th_01_fb.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_4th_01_fb.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_4th_02_fb.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub2'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_4th_02_fb.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_4th_03_fb.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub3'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_4th_03_fb.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_4th_04_fb.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub4'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_4th_04_fb.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_4th_05_fb.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub5'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_4th_05_fb.php');
...
echo "<script LANGUAGE='JavaScript'>
    window.alert('You Have Successfully Added a Record!');
    window.location.href='TCconnect_4th_06_fb.php';
    </script>";
}
  ...
  if (isset($_POST['update_sub6'])) {
   ...
   $query = mysqli_query($connect, $update_record);
    if($query){
      ...
      header('location: TCconnect_4th_06_fb.php');
