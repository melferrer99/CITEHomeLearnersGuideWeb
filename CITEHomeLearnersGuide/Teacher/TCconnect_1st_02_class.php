		...
		<div class="col-12 sidebar-content text-center">
			...
			<div class="col-11 year-form">
				...
				<div class="col-12 section">
						...
						<div class="section-content">
							<a href="connect_1st_02_class.php"><button style="background: green;"><label>1ST Year <h5>(BSIT-02)</h5></label></button></a>
						</div>
...
<!-----------------------------------RIGHTSIDE---------ADD------------------------>
			...
			<div class="col-sm-12 col-md-6 col-lg-8	col-xl-9 rightside">
				...
				<form method="post" action="connect_1st_02_class.php">

				<div class="row rightside-input text-center jumbotron padding">
					<div class="col-12 padding">
							<h3>1ST YEAR BSIT-O2</h3>
				...
				<div class="row rightside-content">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
						<div class="col-12 admin-button">
							...
							<div class="col-12">
								<a type="button" class="btn btn-primary btn-lg form-control" name="del_sub2" href="firstyear-class-process.php?del_sub2=<?php echo $row['class_id']; ?>">DELETE</a>
							</div>
...
<div class="modal fade" id="editmodaladmin<?php echo $row['class_id']?>">
	<div class="modal-dialog">
		<?php include 'editclassmodal1_02.php' ?>
	</div>
</div>
<!--------------------------END MODAL----------------------->
