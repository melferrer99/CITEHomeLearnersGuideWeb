<?php include 'fourthyear-class-process.php'?>
		...
		<div class="col-12 padding">
			<div class="row text-center">
				<div class="col-xs-6 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<button type="button" class="btn btn-lg" style="background: lightgreen; color: #fff;">CLASSROOM</button>
				</div>	
			</div>
		</div>
			...
			<div class="col-11 year-form">
				...
				<div class="col-12 section">
						...
						<div class="section-content">
							<a href="connect_4th_01_class.php"><button style="margin-top: 7px;"><label>4TH Year <h5>(BSIT-01)</h5></label></button></a>
						</div>

						<div class="section-content">
							<a href="connect_4th_02_class.php"><button><label>4TH Year <h5>(BSIT-02)</h5></label></button></a>
						</div>

						<div class="section-content">
							<a href="connect_4th_03_class.php"><button><label>4TH Year <h5>(BSIT-03)</h5></label></button></a>
						</div>

						<div class="section-content">
							<a href="connect_4th_04_class.php"><button style="background: green;"><label>4TH Year <h5>(BSIT-04)</h5></label></button></a>
						</div>

						<div class="section-content">
							<a href="connect_4th_05_class.php"><button><label>4TH Year <h5>(BSIT-05)</h5></label></button></a>
						</div>

						<div class="section-content">
							<a href="connect_4th_06_class.php"><button><label>4TH Year <h5>(BSIT-06)</h5></label></button></a>
						</div>				
				</div>
...
<!-----------------------------------RIGHTSIDE---------ADD------------------------>
			...
			<div class="col-sm-12 col-md-6 col-lg-8	col-xl-9 rightside">
				...
				<form method="post" action="connect_4th_04_class.php">

				<div class="row rightside-input text-center jumbotron padding">
					<div class="col-12 padding">
							<h3>4TH YEAR BSIT-O4</h3>
					...
					<div class="col-sm-12 col-md-6 col-lg-3 col-xl-2 add">
						<div class="col-12">
						<button type="submit" name="addsub04" class="btn btn-primary btn-lg form-control">ADD</button>
						</div>
					</div>
...
<!-------------------------------------DISPLAY--------------------------------------------------->
			<?php while ($row = mysqli_fetch_array($all4)) { ?>
				<div class="row rightside-content">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
						<div class="col-12 admin-button">
							...
							<div class="col-12">
								<a type="button" class="btn btn-primary btn-lg form-control" name="del_sub" href="fourthyear-class-process.php?del_sub4=<?php echo $row['class_id']; ?>">DELETE</a>
							</div>
...
<div class="modal fade" id="editmodaladmin<?php echo $row['class_id']?>">
	<div class="modal-dialog">
		<?php include 'editclassmodal4_04.php' ?>
	</div>
</div>
<!--------------------------END MODAL----------------------->
