		...
		<div class="col-12 sidebar-content text-center">
			...
			<div class="col-11 year-form">
				...
				<div class="col-12 sectionfb">
						...
						<div class="section-content">
							<a href="connect_4th_04_fb.php"><button><label>4TH Year <h5>(BSIT-04)</h5></label></button></a>
						</div>
						...
						<div class="section-content">
							<a href="connect_4th_06_fb.php"><button style="background: blue;"><label>4TH Year <h5>(BSIT-06)</h5></label></button></a>
						</div>				
				</div>
...
<!-----------------------------------RIGHTSIDE---------ADD------------------------>
			...
			<div class="col-sm-12 col-md-6 col-lg-8	col-xl-9 rightside">
				...
				<form method="post" action="connect_4th_06_fb.php">
				...
				<div class="row rightside-content">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
						<div class="col-12 admin-button">
							...
							<div class="col-12">
								<a type="button" class="btn btn-primary btn-lg form-control" name="del_sub" href="fourthyear-fb-process.php?del_sub6=<?php echo $row['class_id']; ?>">DELETE</a>
							</div>
...
<div class="modal fade" id="editmodaladmin<?php echo $row['class_id']?>">
	<div class="modal-dialog">
		<?php include 'editfbmodal4_06.php' ?>
	</div>
</div>
<!--------------------------END MODAL----------------------->
