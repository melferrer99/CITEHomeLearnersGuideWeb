...
class Actions
{
	...
	public function insert($ref,$learning,$year,$section,$title,$fields)
		{	
			...
			header('Location:\CITEHomeLearnersGuide\TCconnect_1st_04_class.php?msg=inserted');
		}
	...
	public function delete($ref,$key)
		{
			...
			header('Location:\CITEHomeLearnersGuide\TCconnect_1st_04_class.php?msg=deleted');
		}
	...
	public function update($ref,$learning,$key,$year,$section,$title,$data)
		{
			...
			header('Location:\CITEHomeLearnersGuide\TCconnect_1st_04_class.php?msg=update');
