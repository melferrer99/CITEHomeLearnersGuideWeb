...
class Actions
{
	...
	public function insert($ref,$learning,$year,$section,$title,$fields)
		{	
			...
			header('Location:\CITEHomeLearnersGuide\TCconnect_1st_02_fb.php?msg=inserted');
		}
	...
	public function delete($ref,$key)
		{
			...
			header('Location:\CITEHomeLearnersGuide\TCconnect_1st_02_fb.php?msg=deleted');
		}
	...
	public function update($ref,$learning,$key,$year,$section,$title,$data)
		{
			...
			header('Location:\CITEHomeLearnersGuide\TCconnect_1st_02_fb.php?msg=update');
