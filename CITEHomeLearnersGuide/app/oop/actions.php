...
class Actions
{
	...
	public function insert($ref,$user,$fields)
		{	
			...
			header('Location:\CITEHomeLearnersGuide\user.php?msg=inserted');
		}
	...
	public function delete($ref,$key)
		{
			...
			header('Location:\CITEHomeLearnersGuide\user.php?msg=deleted');
		}
	...
	public function update($ref,$key,$data)
		{
			...
			header('Location:\CITEHomeLearnersGuide\user.php?msg=update');
