...
<div class="container-fluid">
	<div class="row">
		...
		<div class="container col-4">	
			<div class="col-12 text-center"><h1>FLEX</h1></div>

			<div class="body-content col-12 text-center">
				<div class="col-12">
					<a href="FLEXclassroomNEW.php"> <button type="button" class="btn btn-lg" style="background: lightgreen; color: #fff;">CLASSROOM</button> </a>
					<a href="FLEXfacebookNEW.php"><button type="button" class="btn btn-primary btn-lg">FACEBOOK</button></a>
				</div>
			</div>
		</div>
