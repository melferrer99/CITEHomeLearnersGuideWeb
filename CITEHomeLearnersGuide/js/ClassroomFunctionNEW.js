      ...
      firebase.analytics();
        ...
        function submit(){
        var subjectYear =document.getElementById("subjectYear");
        ...
        var gclasstLink =document.getElementById("gclasstLink");
        ...
        //     var htmls = [];
        //     $.each(value, function (index, value) {
        //         if (value['subjectYear'] == subYear && value['subjectTitle'] == subTitle) {
        //             htmls.push('<tr>\
        //             <td>' + value.subjectYear + '</td>\
        //             <td>' + value.subjectSection + '</td>\
        //             <td>' + value.subjectCode + '</td>\
