      ...
      firebase.analytics();
        ...
        $('.ADDUser').on('click', function () {
            ...
            firebase.database().ref('GoogleClassroom/' + LSystem + '/' + year + '/' + section + '/'+ code + '/' + 'StudentsJoined' + '/' + addID).set({
         ...
         $('.ADDUser').on('click', function () {
            ...
            firebase.database().ref('JoinClasses/' + StudentNo + '/GClass/' + code + '/' ).set({
   ...
   $('#getData').on('click', function () {
        ...
        firebase.database().ref('Classroom/' + sortLS + '/' + uname + '/' + code + '/' + 'StudentsJoined/').on('value', function (snapshot) {
        ...
        $('.deleteRecord').on('click', function () {
            ...
            firebase.database().ref('Classroom/' + sortLS + '/' + uname + '/' + code + '/' + 'StudentsJoined/' + id).remove();
