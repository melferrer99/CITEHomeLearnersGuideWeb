...
<!------------------------------------->
    ...
    <div class="container-fluid" style="margin-top: 10px;">
        ...
        <div class="row rightside-input text-center jumbotron padding col-7" style="margin: auto;">	
            ...
            <div class="col-12">
            	<h4 class="padding">ADD ADMIN/TEACHER</h4>
...
<!--                     <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2 ">
                        <div class="col-12">
                            <a href="userStudent.php"><button type="button" class="btn btn-success mb-3">STUDENT</button></a>
                        </div>
                    </div>
 -->
                </form>
    ...
    <script type="text/javascript" src="js/addAdminFunction.js"></script>
