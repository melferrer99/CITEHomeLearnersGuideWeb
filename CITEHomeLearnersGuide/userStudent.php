	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link active" data-toggle="modal" data-target="#modaluser">USER</a>
				</li>
				<li class="nav-item">
...
<!------------------------------------->
    ...
    <div class="container-fluid" style="margin-top: 10px;">
        ...
        <div class="row rightside-input text-center jumbotron padding col-8" style="margin: auto;">	
            ...
            <div class="col-12">
            	<h4 class="padding">ADD STUDENT</h4>
                <form id="addUser" class="form-inline" method="POST" action="">

                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2 subcode ">
    ...
    <!--                           <select id="SORTsection" type="text" class="form-control" name="SORTsection" required="" autofocus="">
     ...
     -->                           <input id="SORTsection" type="text" class="form-control" name="SORTsection" placeholder="Section" required autofocus>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2 padding">
                                <div class="col-12">
                                    <a href="userStudent.php"><button type="button" class="btn btn-primary form-control">View all</button></a>
                                </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="js/addStudentFunction.js"></script>
